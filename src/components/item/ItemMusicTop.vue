<template>
  <div class="itemMusicTop">
    ...
    <div class="itemLeft">
      <svg t="1666770886096" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="23705" width="200" height="200" @click="$router.go(-1)">
        <!-- 点击跳回上一页 -->
        <path
  ...
  <div class="itemTopContent">
    <div class="contentLeft">
      ...
      <div class="playCount">
        <svg t="1666767146341" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="21950" width="200" height="200">
          <path
    ...
    <div class="contentRight">
      ...
      <div class="right_img">
        ...
        <svg t="1666773745260" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="25397" width="200" height="200">
          <path
  ...
  <div class="itemTopFooter">
    <div class="footerItem">
      <svg t="1666773989252" class="icon" viewBox="0 0 1025 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="27201" width="200" height="200">
        <path
    ...
    <div class="footerItem">
      <svg t="1666774047550" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="footerItem">
      <svg t="1666774114775" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="34063" width="200" height="200">
        <path
    ...
    <div class="footerItem">
      <svg t="1666774138411" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="34983" width="200" height="200">
        <path
